    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Luxusní apartmán s výhledem na oceán v Los Gigantes, Tenerife.
              Váš dokonalý únik na Kanárské ostrovy.
            </p>
          </div>
          ...
          {/* Location */}
          <div>
            <h4 className="text-lg font-semibold mb-4">Lokalita</h4>
            <div className="flex items-start space-x-3 text-gray-400">
              ...
              <div className="text-sm">
                ...
                <p>Santa Cruz de Tenerife, Španělsko</p>
                <a
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Cielo Dorado. All rights reserved.</p>
